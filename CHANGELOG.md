...
- Correct BigQuery setup examples in the README and docs: `bigquery` is a DuckDB community extension, so installing it
  requires `INSTALL bigquery FROM community;` instead of `INSTALL bigquery;`, which 404s against the core extension
  repository.
...
[Unreleased]: https://github.com/ottogroup/koality/compare/v0.13.3...HEAD
[0.13.3]: https://github.com/ottogroup/koality/compare/v0.13.2...v0.13.3
